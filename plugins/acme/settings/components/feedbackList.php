...
class feedbackList extends \Cms\Classes\ComponentBase
{
    ...
    public function onRun()
    {
        ...
        $this->addCss('/plugins/acme/settings/assets/css/lightslider.min.css');
        $this->addJs('/plugins/acme/settings/assets/js/lightslider.min.js');
        $this->addJs('/plugins/acme/settings/assets/js/slider.js');
